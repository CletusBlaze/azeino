...
export default function LandingPage() {
  return (
    <div style={{ minHeight: '100vh', color: 'var(--color-text)' }}>
      {/* Nav */}
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 48px', borderBottom: '1px solid var(--color-border)', position: 'sticky', top: 0, background: 'rgba(7,11,20,0.7)', backdropFilter: 'blur(16px)', zIndex: 10 }}>
      ...
      {/* Capabilities */}
      <section id="capabilities" style={{ padding: '60px 48px', maxWidth: 1100, margin: '0 auto' }}>
      ...
      {/* CTA */}
      <section style={{ textAlign: 'center', padding: '80px 24px', margin: '0 48px 48px', background: 'linear-gradient(135deg, rgba(99,102,241,0.1), rgba(34,211,238,0.05))', border: '1px solid rgba(99,102,241,0.2)', borderRadius: 'var(--radius-xl)' }}>
